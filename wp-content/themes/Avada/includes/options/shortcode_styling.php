			...
			'sectionseparator_shortcode_section' => array(
				...
				'fields'      => array(
					...
					'section_sep_bg' => array(
						'label'       => esc_html__( 'Section Separator Divider Candy Background Color', 'fusion-builder' ),
						'description' => esc_html__( 'Controls the background color of the divider candy.', 'fusion-builder' ),
						'id'          => 'section_sep_bg',
						'default'     => '#f6f6f6',
						'type'        => 'color-alpha',
						'option_name' => $option_name,
