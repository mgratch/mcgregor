 ...
 * This class works in conjunction with Avada_Patcher_Admin_Screen
 *
 * @since 4.0.0
 */
class Avada_Patcher_Admin_Notices {
	 ...
	 * @var string
	 */
	private static $option_name = 'avada_patcher_messages';
	 ...
	 * @access private
	 * @since 5.0.0
	 * @see Avada_Patcher_Admin_Screen::form for the option deletion process.
	 * @return void
	 */
	 ...
	 * @return void
	 */
	public static function remove_messages_option() {
