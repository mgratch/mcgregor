                ...
                <div id="chart-container-tabs-1"
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input type="number" name="chart-width" id="chart-width"
                                               class="form-control input-sm" value="0" readonly/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="responsive-width">
                        ...
                        <div class="toggle-switch p-b-20 p-t-5" data-ts-color="blue">
                            ...
                            <input id="chart-responsive-width" type="checkbox" hidden="hidden" checked>
                    ...
                    <div class="highcharts" id="panning-row">
                        ...
                        <div class="toggle-switch p-b-20 p-t-5" data-ts-color="blue">
                            ...
                            <input id="panning" type="checkbox" hidden="hidden">
                            <label for="panning" class="ts-helper"></label>
                        </div>
                    </div>
                    ...
                    <div class="google" id="three-d-row">
                        ...
                        <div class="toggle-switch p-b-20 p-t-5" data-ts-color="blue">
                            ...
                            <input id="three-d" type="checkbox" hidden="hidden">
                            <label for="three-d" class="ts-helper"></label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="inside">
                        <div id="tooltip-enabled-row">
                            ...
                            <div class="toggle-switch p-b-20 p-t-5" data-ts-color="blue">
                                ...
                                <input id="tooltip-enabled" type="checkbox" hidden="hidden" checked>
                        ...
                        <div class="highcharts">
                            ...
                            <div class="form-group">
                                <div class="fg-line">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="number" name="tooltip-border-width" id="tooltip-border-width"
                        ...
                        <div class="highcharts chartjs">
                            ...
                            <div class="form-group">
                                <div class="fg-line">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="number" min="0" name="tooltip-border-radius"
                                                   id="tooltip-border-radius" value="3" class="form-control input-sm"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="highcharts chartjs">
                            ...
                            <div class="toggle-switch p-b-20 p-t-5" data-ts-color="blue">
                                ...
                                <input id="tooltip-shared" type="checkbox" hidden="hidden">
                                <label for="tooltip-shared" class="ts-helper"></label>
                            </div>
                        </div>
                        <div class="highcharts">
                            <h4 class="c-black m-b-20">
                    ...
                    <div class="inside">
                        <div class="highcharts chartjs">
                            ...
                            <div class="toggle-switch p-b-20 p-t-5" data-ts-color="blue">
                                ...
                                <input id="show-legend" type="checkbox" hidden="hidden" checked>
                                <label for="show-legend" class="ts-helper"></label>
                            </div>
                        </div>
                        ...
                        <div class="highcharts">
                            ...
                            <div class="form-group">
                                <div class="fg-line">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="number" name="legend_border_width" id="legend_border_width"
                        ...
                        <div class="highcharts">
                            ...
                            <div class="form-group">
                                <div class="fg-line">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="number" min="0" name="legend_border_radius"
                                                   id="legend_border_radius" value="0" class="form-control input-sm"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="inside">
                        <div>
                            ...
                            <div class="toggle-switch p-b-20 p-t-5" data-ts-color="blue">
                                ...
                                <input id="exporting" type="checkbox" hidden="hidden">
                                <label for="exporting" class="ts-helper"></label>
                            </div>
                        </div>
                        <div>
                            <h4 class="c-black m-b-20">
                            ...
                            <div class="toggle-switch p-b-20 p-t-5" data-ts-color="blue">
                                ...
                                <input id="exporting-data-labels" type="checkbox" hidden="hidden">
                                <label for="exporting-data-labels" class="ts-helper"></label>
                            </div>
                        </div>
                        <div>
                            <h4 class="c-black m-b-20">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                <div class="fg-line">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="number" min="0" name="exporting-width" id="exporting-width"
                                                   class="form-control input-sm"/>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="inside">
                        <div>
                            ...
                            <div class="toggle-switch p-b-20 p-t-5" data-ts-color="blue">
                                ...
                                <input id="credits" type="checkbox" hidden="hidden" checked>
                                <label for="credits" class="ts-helper"></label>
                            </div>
                        </div>
                        <div>
                            <h4 class="c-black m-b-20">
