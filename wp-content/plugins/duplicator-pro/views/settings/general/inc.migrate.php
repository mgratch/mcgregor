...
<!-- ==============================
IMPORT -->
<form enctype="multipart/form-data"  id="dup-tools-form-import" action="<?php echo self_admin_url('admin.php?page=duplicator-pro-settings&section=migrate'); ?>" method="post" data-parsley-validate data-parsley-ui-enabled="true" >
