...
function seed_cspv5_section_drip( $emaillist,$page_id ) {
...
?>
    <div class="postbox">
        ...
        <p><a href="http://support.seedprod.com/article/122-collecting-email-with-drip" target="_blank">Learn how to Configure</a></p>
 ...
 *  Get List from Drip
 */
function seed_cspv5_get_drip_lists() {
 ...
 *  Subscribe MailChimp
 */
add_action( 'seed_cspv5_emaillist_drip', 'seed_cspv5_emaillist_drip_add_subscriber' );

function seed_cspv5_emaillist_drip_add_subscriber( $args ) {
