 ...
 */
add_filter('seed_cspv5_enable_wp_head_footer_list','seed_cspv5_enable_wp_head_footer_mymail');

function seed_cspv5_enable_wp_head_footer_mymail($arr){
  $arr[] = 'mymail';
  return $arr;
}
...
function seed_cspv5_section_mymail($emaillist,$page_id) {
    // Get settings
...
?>
    <div class="postbox">
        <h3 class="hndle"><?php _e('MyMail', 'seedprod') ?></h3>
        <div class="inside">
        ...
        <p><a href="http://support.seedprod.com/article/78-collecting-emails-with-mymail" target="_blank">Learn how to Configure</a></p>
 ...
 */
add_filter('seed_cspv5_show_form_mymail', 'cspv5_show_form_mymail_shortcode',10,1);

function cspv5_show_form_mymail_shortcode($output){
