...
function seed_cspv5_section_mailpoet($emaillist,$page_id) {
    // Get settings
...
?>
    <div class="postbox">
        ...
        <div class="inside">
        <p><?php __('Configure saving subscribers to MailPoet options. <a href="http://support.seedprod.com/article/77-collecting-emails-with-mailpoet" target="_blank">Learn More</a>', 'seedprod') ?></p>
        ...
        <p><a href="http://support.seedprod.com/article/77-collecting-emails-with-mailpoet" target="_blank">Learn how to Configure</a></p>
 ...
 */
function seed_cspv5_get_mailpoet_lists(){
    $lists = array();
 ...
 *  Subscribe MailPoet
 */
add_action('seed_cspv5_emaillist_mailpoet', 'seed_cspv5_emaillist_mailpoet_add_subscriber');

function seed_cspv5_emaillist_mailpoet_add_subscriber($args){
