...
<?php } ?>
        ...
        <input autocomplete='off' id='seed_cspv5_license_key' class='regular-text' type='text' value='<?php echo get_option('seed_cspv5_license_key') ?>' placeholder="License Key" />
