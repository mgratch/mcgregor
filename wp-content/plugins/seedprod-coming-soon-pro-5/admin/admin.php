...
// var_dump(version_compare( $seed_cspv5_current_version,SEED_CSPV5_VERSION));
    ...
    function subscribe_callback(){
        //if(check_ajax_referer('seed_cspv5_subscribe_callback')){
            ...
            $bypassed_emaillist = apply_filters('seed_cspv5_bypassed_emaillist',array('gravityforms'));
            ...
            if(!in_array($emaillist, $bypassed_emaillist)){
                if(!empty($enable_recaptcha)){
                    ...
                    if($body->success === false){
                         ...
                         $seed_cspv5_post_result['msg'] = 'Invalid Recapcha';
        ...
        if('200' == $seed_cspv5_post_result['status']){
            ...
            if(!empty($settings['enable_reflink'])){
                ...
                $html .= '<br><br>'.$txt_stats_referral_stats.'<br>'.$txt_stats_referral_subscribers.': '.$seed_cspv5_post_result['subscribers'].'</div>';
                $html = $html;
            }
...
class SEED_CSPV5_SUBSCRIBERS extends WP_List_Table {
    ...
    function get_bulk_actions() {
      $actions = array(
        ...
        //'seed_cspv5_delete_subscribers'    => __('Delete All','seedprod'),
