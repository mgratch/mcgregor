            ...
            ?>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="seo_description" class="form-control input-sm" maxlength="200" name="seo_description" type="text" value="<?php echo htmlentities($settings->seo_description,ENT_QUOTES, "UTF-8") ?>">       
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div id="bg_video_settings">
                                <div class="form-group">
                                    ...
                                    <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php _e('Paste in the YouTube.com video url or MP4 link to add background video. Please only use videos you own the right to.','seedprod-coming-soon-pro') ?>"></i>
                    ...
                    <div class="panel-body">
                        ...
                        <div id="socialbuttons_settings">
                            ...
                            <ul id="share_buttons" class="list-unstyled">
                                ...
                                <li>
                                    <div class="form-group">
                                        <label class="control-label">Facebook Thumbnail</label> <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php _e('Image must be at least 200px * 200px.','seedprod-coming-soon-pro') ?>"></i>
          ...
          <div class="form-group">
            ...
            <div id="footercredit_settings">
                ...
                <div class="form-group">
                    ...
                    <input id="footer_credit_text" class="form-control input-sm" name="footer_credit_text" type="text" value="<?php echo $settings->footer_credit_text ?>">    
                </div>
                <div class="form-group">
